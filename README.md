...
Welcome to my **Hack The Box** repository! 
This repository serves as a central hub to document my journey in cybersecurity, penetration testing, and CTF challenges.

## Purpose
Here you will find detailed write-ups, scripts, and methodologies used to solve various labs and challenges on Hack The Box.
...
```text
.
├── Machines/       # Full system exploitation (Boot2Root)
│   ├── Linux/
│   └── Windows/
...
│   ├── Reversing/
│   └── Misc/
└── tools/          # Custom scripts and tools developed during the process
```
